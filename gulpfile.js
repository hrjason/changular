...
var _HTML_DEFAULT_SCRIPTS_JS = [
  ...
  {src: 'node_modules/zone.js/lochang-stack-trace-zone.js', mimeType: 'text/javascript', copy: true},
...
var CONFIG = {
  ...
  transpile: {
    src: {
      ...
      ts2dart: ['modules/changular2/src/di/*.js', 'modules/changular2/test/di/*.js', 'modules/changular2/src/test_lib/*.js']
    },
    options: {
      js: {
  ...
  html: {
    ...
    scriptsPerFolder: {
      js: {
        ...
        'benchmarks_external/**':
          [
            { src: 'node_modules/changular/changular.js', mimeType: 'text/javascript', copy: true },
            { src: 'tools/build/snippets/url_params_to_form.js', mimeType: 'text/javascript', copy: true }
          ].concat(_HTML_DEFAULT_SCRIPTS_JS),
  ...
  test: {
    js: {
      cjs: [
        '/changular2/test/change_detection/**/*_spec.js',
        '/changular2/test/core/annotations/**/*_spec.js',
        '/changular2/test/core/compiler/**/*_spec.js',
        '/changular2/test/di/**/*_spec.js',
        '/changular2/test/directives/**/*_spec.js',
        '/changular2/test/facade/**/*_spec.js',
        '/changular2/test/forms/**/*_spec.js',
        '/changular2/test/mock/**/*_spec.js',
        '/changular2/test/reflection/**/*_spec.js',
        '/changular2/test/services/**/*_spec.js',
        '/changular2/test/test_lib/**/*_spec.js'
      ]
    }
  }
};
...
gulp.task('build/transformCJSTests', function() {
  return gulp.src(CONFIG.dest.js.cjs + '/changular2/test/**/*_spec.js').pipe(transformCJSTests()).pipe(gulp.dest(CONFIG.dest.js.cjs + '/changular2/test/'));
});
...
gulp.task('test.unit.cjs', ['build.js.cjs'], function () {
  ...
  //Watcher to run tests when dist/js/cjs/changular2 is updated by the first watcher (after clearing the node cache)
  gulp.watch(CONFIG.dest.js.cjs + '/changular2/**/*.js', function(event) {
...
gulp.task('tests/transform.dart', function() {
  return gulp.src('modules/changular2/test/transform/**')
    .pipe(gulp.dest('dist/dart/changular2/test/transform'));
});
