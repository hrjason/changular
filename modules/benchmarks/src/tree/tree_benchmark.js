...
import {bootstrap, Component, Viewport, Template, ViewContainer, Compiler, NgElement, Decorator} from 'changular2/changular2';

import {CompilerCache} from 'changular2/src/core/compiler/compiler';
...
import {Content} from 'changular2/src/core/compiler/shadow_dom_emulation/content_tag';
import {DestinationLightDom} from 'changular2/src/core/compiler/shadow_dom_emulation/light_dom';
...
import {window, document, gc} from 'changular2/src/facade/browser';
...
import {If} from 'changular2/directives';
...
export function main() {
  ...
  BASELINE_TREE_TEMPLATE = DOM.createTemplate(
    '<span>_<template class="chang-binding"></template><template class="chang-binding"></template></span>');
...
// http://jsperf.com/nextsiblichang-vs-childnodes
