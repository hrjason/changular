import {getIntParameter, getStringParameter, bindAction} from 'changular2/src/test_lib/benchmark_util';
...
export function main() {
  changular.bootstrap(document.querySelector('largetable'), ['app']);
}

changular.module('app', [])
...
.directive('baselineBindingTable', function() {
  return {
    ...
    link: function ($scope, $element) {
      ...
      template.setAttribute('chang-repeat', 'foo in foos');
      template.classList.add('chang-scope');
