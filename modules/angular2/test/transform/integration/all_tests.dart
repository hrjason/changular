library changular2.test.transform.integration;

import 'dart:io';
import 'package:changular2/src/dom/html5lib_adapter.dart';
import 'package:changular2/transformer.dart';
...
var transform = new changularTransformerGroup(new TransformerOptions(
...
void allTests() {
   ...
   */
  var commonInputs = {
    'changular2|lib/src/core/annotations/annotations.dart':
        '../../../lib/src/core/annotations/annotations.dart',
    'changular2|lib/src/core/application.dart': '../common/application.dart',
  ...
  var tests = [
    ...
    new IntegrationTestConfig('should preserve multiple annotations.',
      ...
      'changular2|lib/src/core/annotations/template.dart':
