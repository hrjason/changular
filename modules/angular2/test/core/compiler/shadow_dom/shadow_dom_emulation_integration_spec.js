...
import {StringMapWrapper, List} from 'changular2/src/facade/collection';
  ...
  describe('integration tests', function() {
    ...
    StringMapWrapper.forEach(strategies,
      ...
      describe(`${name} shadow dom strategy`, () => {
        ...
        //  var temp = `<simple>aaa<input type="text" id="focused-input" chang-class="{'aClass' : showClass}"> bbb</simple>`;
        //
