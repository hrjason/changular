import {describe, ddescribe, it, iit, xit, xdescribe, expect, beforeEach, SpyObject, proxy, el} from 'changular2/test_lib';
import {isBlank, isPresent, IMPLEMENTS} from 'changular2/src/facade/lang';
import {ListWrapper, MapWrapper, List, StringMapWrapper} from 'changular2/src/facade/collection';
import {DOM} from 'changular2/src/dom/dom_adapter';
import {ProtoElementInjector, PreBuiltObjects, DirectiveBinding} from 'changular2/src/core/compiler/element_injector';
import {Parent, Ancestor} from 'changular2/src/core/annotations/visibility';
import {EventEmitter, PropertySetter} from 'changular2/src/core/annotations/di';
import {onDestroy} from 'changular2/src/core/annotations/annotations';
import {Optional, Injector, Inject, bind} from 'changular2/di';
import {ProtoView, View} from 'changular2/src/core/compiler/view';
import {ViewContainer} from 'changular2/src/core/compiler/view_container';
import {NgElement} from 'changular2/src/core/dom/element';
import {LightDom, DestinationLightDom} from 'changular2/src/core/compiler/shadow_dom_emulation/light_dom';
