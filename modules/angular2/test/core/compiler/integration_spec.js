...
import {Type, isPresent, BaseException, assertionsEnabled, isJsObject} from 'changular2/src/facade/lang';
import {PromiseWrapper} from 'changular2/src/facade/async';

import {Injector, bind} from 'changular2/di';
import {Lexer, Parser, dynamicChangeDetection,
  DynamicChangeDetection, Pipe, PipeRegistry} from 'changular2/change_detection';
...
import {ShadowDomStrategy, EmulatedUnscopedShadowDomStrategy} from 'changular2/src/core/compiler/shadow_dom_strategy';
import {PrivateComponentLocation} from 'changular2/src/core/compiler/private_component_location';
...
import {BindingPropagationConfig} from 'changular2/src/core/compiler/binding_propagation_config';
...
import {EventManager} from 'changular2/src/core/events/event_manager';

import {Decorator, Component, Viewport, DynamicComponent} from 'changular2/src/core/annotations/annotations';
import {Template} from 'changular2/src/core/annotations/template';
import {Parent, Ancestor} from 'changular2/src/core/annotations/visibility';
...
export function main() {
  describe('integration tests', function() {
    ...
    describe('react to record changes', function() {
      ...
      // GH issue 328 - https://github.com/changular/changular/issues/328
    ...
    // - https://github.com/changular/changular/issues/776
    // - https://github.com/changular/changular/commit/81f3f32
