import {describe, xit, it, expect, beforeEach, ddescribe, iit, el, proxy} from 'changular2/test_lib';
import {ProtoView, ElementPropertyMemento, DirectivePropertyMemento} from 'changular2/src/core/compiler/view';
import {ProtoElementInjector, ElementInjector, DirectiveBinding} from 'changular2/src/core/compiler/element_injector';
import {EmulatedScopedShadowDomStrategy, NativeShadowDomStrategy} from 'changular2/src/core/compiler/shadow_dom_strategy';
import {DirectiveMetadataReader} from 'changular2/src/core/compiler/directive_metadata_reader';
import {Component, Decorator, Viewport, Directive, onChange} from 'changular2/src/core/annotations/annotations';
import {Lexer, Parser, DynamicProtoChangeDetector,
  ChangeDetector} from 'changular2/change_detection';
import {EventEmitter} from 'changular2/src/core/annotations/di';
import {List, MapWrapper} from 'changular2/src/facade/collection';
import {DOM} from 'changular2/src/dom/dom_adapter';
import {int, IMPLEMENTS} from 'changular2/src/facade/lang';
import {Injector} from 'changular2/di';
import {View, PropertyUpdate} from 'changular2/src/core/compiler/view';
import {ViewContainer} from 'changular2/src/core/compiler/view_container';
    ...
    describe('instantiated and hydrated', function() {
      ...
      function createCollectDomNodesTestCases(useTemplateElement:boolean) {
        ...
        describe('collect elements with property bindings', () => {
          ...
          it('should collect property bindings on the root element if it has the chang-binding class', () => {
            var pv = new ProtoView(templateAwareCreateElement('<div [prop]="a" class="chang-binding"></div>'),
              new DynamicProtoChangeDetector(null), null);
          ...
          it('should collect property bindings on child elements with chang-binding class', () => {
            var pv = new ProtoView(templateAwareCreateElement('<div><span></span><span class="chang-binding"></span></div>'),
              new DynamicProtoChangeDetector(null), null);
            pv.bindElement(null, 0, null);
        ...
        describe('collect text nodes with bindings', () => {
          ...
          it('should collect text nodes under the root element', () => {
            var pv = new ProtoView(templateAwareCreateElement('<div class="chang-binding">{{}}<span></span>{{}}</div>'),
              new DynamicProtoChangeDetector(null), null);
            pv.bindElement(null, 0, null);
          ...
          it('should collect text nodes with bindings on child elements with chang-binding class', () => {
            var pv = new ProtoView(templateAwareCreateElement('<div><span> </span><span class="chang-binding">{{}}</span></div>'),
              new DynamicProtoChangeDetector(null), null);
            pv.bindElement(null, 0, null);
      ...
      describe('create ElementInjectors', () => {
        it('should use the directives of the ProtoElementInjector', () => {
          var pv = new ProtoView(el('<div class="chang-binding"></div>'),
            new DynamicProtoChangeDetector(null), null);
        ...
        it('should use the correct parent', () => {
          var pv = new ProtoView(el('<div class="chang-binding"><span class="chang-binding"></span></div>'),
            new DynamicProtoChangeDetector(null), null);
      ...
      describe('collect root element injectors', () => {
        ...
        it('should collect multiple root element injectors', () => {
          var pv = new ProtoView(el('<div><span class="chang-binding"></span><span class="chang-binding"></span></div>'),
            new DynamicProtoChangeDetector(null), null);
          pv.bindElement(null, 0, new ProtoElementInjector(null, 1, [SomeDirective]));
      ...
      describe('with component views', () => {
        ...
        function createComponentWithSubPV(subProtoView) {
          var pv = new ProtoView(el('<cmp class="chang-binding"></cmp>'),
        ...
        it('should expose component services and component instance to directives in the shadow Dom',
          () => {
            var subpv = new ProtoView(
              el('<div dec class="chang-binding">hello shadow dom</div>'),
      ...
      describe('with template views', () => {
        function createViewWithViewport() {
          ...
          var pv = new ProtoView(el('<someTmpl class="chang-binding"></someTmpl>'),
            new DynamicProtoChangeDetector(null), new NativeShadowDomStrategy(null));
      ...
      if (DOM.supportsDOMEvents()) {
        describe('event handlers', () => {
          ...
          function createProtoView() {
            var pv = new ProtoView(el('<div class="chang-binding"><div></div></div>'),
              new DynamicProtoChangeDetector(null), null);
