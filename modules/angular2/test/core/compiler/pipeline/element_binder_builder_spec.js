...
import {isPresent, normalizeBlank} from 'changular2/src/facade/lang';
import {DOM} from 'changular2/src/dom/dom_adapter';
import {ListWrapper, MapWrapper, Map, StringMap, StringMapWrapper} from 'changular2/src/facade/collection';

import {ElementBinderBuilder} from 'changular2/src/core/compiler/pipeline/element_binder_builder';
...
export function main() {
  describe('ElementBinderBuilder', () => {
      ...
      return new CompilePipeline([
        new MockStep((parent, current, control) => {
            ...
            if (hasBinding) {
              ...
              DOM.addClass(current.element, 'chang-binding');
            }
    ...
    it('should bind class with a dot', () => {
      ...
      evalContext.prop1 = true;
      changeDetector.detectChanges();
      expect(view.nodes[0].className).toEqual('foo chang-binding bar');

      evalContext.prop1 = false;
      changeDetector.detectChanges();
      expect(view.nodes[0].className).toEqual('foo chang-binding');
    });
