...
import {Log, once} from 'changular2/test_lib';
...
export function main() {
  describe("VmTurnZone", () => {
    ...
    describe("runOutsidechangular", () => {
      it("should run a function outside of the changular zone", () => {
        zone.runOutsidechangular(log.fn('run'));
