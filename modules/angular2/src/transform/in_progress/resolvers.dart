...
/// Provides resolved [Elements] for well-known changular2 symbols.
class changular2Types {
  static Map<Resolver, changular2Types> _cache = {};
  static final _annotationsLibAssetId =
      new AssetId('changular2', 'lib/src/core/annotations/annotations.dart');
  static final _applicationLibAssetId =
      new AssetId('changular2', 'lib/src/core/application.dart');
  static final _templateLibAssetId =
      new AssetId('changular2', 'lib/src/core/annotations/template.dart');
  static final _reflectionCapabilitiesLibAssetId = new AssetId(
      'changular2', 'lib/src/reflection/reflection_capabilities.dart');

  final Resolver _resolver;
  FunctionElement _bootstrapMethod;

  changular2Types._internal(this._resolver);

  factory changular2Types(Resolver resolver) {
    return _cache.putIfAbsent(
        resolver, () => new changular2Types._internal(resolver));
  }
