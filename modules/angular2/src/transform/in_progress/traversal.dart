...
/// Walks through an changular2 application, finding all classes matching the
/// provided [annotationMatcher].
class changularVisibleTraversal {
  final changular2Types _types;
  final _ComponentParsingAstVisitor _visitor;

  changularVisibleTraversal(this._types, AnnotationMatcher annotationMatcher)
      : _visitor = new _ComponentParsingAstVisitor(annotationMatcher);

  /// Walks an changular2 application, starting with the class represented by
  /// [entryPoint], which must be annotated as an changular2 [Component].
  ///
...
class _ComponentParsingAstVisitor extends Object
  ...
  Object visitAnnotation(Annotation node) {
    // TODO(kegluneq): Visit only changular2 annotations & subtypes.
