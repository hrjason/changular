...
/// Finds all calls to the changular2 [bootstrap] method defined in [library].
...
Set<BootstrapCallInfo> findBootstrapCalls(
  ...
  var types = new changular2Types(resolver);
...
/// Information about a single call to changular2's [bootstrap] method.
class BootstrapCallInfo {
  ...
  /// of the changular2 app.
  final ClassElement bootstrapType;

  BootstrapCallInfo(this.call, this.bootstrapType);
}

/// Visitor that finds the changular2 bootstrap component given [bootstrap]'s
/// first argument.
///
