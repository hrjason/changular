...
/// Finds all calls to the changular2 [ReflectionCapabilities] constructor
/// defined in [library].
...
class _SetupReflectionCodegen {
  ...
  /// changular2 reflection statically.
  ///
  ...
  /// Generates code to call the method which sets up changular2 reflection
  /// statically.
  ///
  /// The code generated here should follow the example of code generated for
