...
library  changular2.transform.generated;
''';

const _reflectorImport = '''
import 'package:changular2/src/reflection/reflection.dart' show reflector;
''';
...
// TODO(https://github.com/kegluneq/changular/issues/4): Remove calls to
// Element#node.
class _DirectiveRegistryImpl implements DirectiveRegistry {
  ...
  /// Creates the 'annotations' property for the changular2 [registerType] call
  /// for [node].
  void _codegenAnnotationsProp(ClassDeclaration node) {
    node.accept(_annotationsVisitor);
  }

  /// Creates the 'factory' property for the changular2 [registerType] call
  ...
  /// Creates the 'parameters' property for the changular2 [registerType] call
  /// for [node].
...
/// ToSourceVisitor designed to print 'parameters' values for changular2's
/// [registerType] calls.
...
/// ToSourceVisitor designed to print 'factory' values for changular2's
/// [registerType] calls.
...
/// 'annotations' value for changular2's [registerType] calls.
...
/// `registerSetters` call for changular2.
