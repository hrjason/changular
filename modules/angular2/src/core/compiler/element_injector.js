import {isPresent, isBlank, Type, int, BaseException} from 'changular2/src/facade/lang';
import {Math} from 'changular2/src/facade/math';
import {List, ListWrapper, MapWrapper} from 'changular2/src/facade/collection';
import {Injector, Key, Dependency, bind, Binding, NoProviderError, ProviderError, CyclicDependencyError} from 'changular2/di';
...
import * as viewModule from 'changular2/src/core/compiler/view';
...
import {Directive, onChange, onDestroy} from 'changular2/src/core/annotations/annotations';
import {BindingPropagationConfig} from 'changular2/src/core/compiler/binding_propagation_config';
import * as pclModule from 'changular2/src/core/compiler/private_component_location';
...
ElementInjector:
 ...
 PERF BENCHMARK: http://www.williambrownstreet.net/blog/2014/04/faster-changularjs-renderichang-changularjs-and-reactjs/
 */
