    ...
    if (isPresent(cssRules)) {
      for (var i = 0; i < cssRules.length; i++) {
        ...
        if (DOM.isStyleRule(rule) || DOM.isPageRule(rule)) {
          ...
          // from the CSSRuleSet
          // https://connect.microsoft.com/IE/feedbackdetail/view/955703/accessichang-csstext-of-a-keyframe-rule-that-contains-a-webkit-property-via-cssom-generates-exception
          try {
