...
// - [Describing more complex types](#describichang-more-complex-types)
//   - [assert.arrayOf](#assert-arrayof)
//   - [assert.structure](#assert-structure)
// - [Integrating with Traceur](#integratichang-with-traceur)
...
// Jump to the [Traceur section](#integratichang-with-traceur) to see an example of that.
...
//
// See [Describing More Complex Types](#describichang-more-complex-types) for examples how to
...
describe('Traceur', function() {
  ...
  describe('arguments', function() {
    ...
    it('should pass', function() {
      expect(reverse('changular')).toBe('ralugna');
    });
