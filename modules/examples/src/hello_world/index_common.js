import {bootstrap, Component, Decorator, Template, NgElement} from 'changular2/changular2';
import {Injectable} from 'changular2/di';

// changular 2.0 supports 3 basic types of directives:
// - Component - the basic building blocks of changular 2.0 apps. Backed by
...
// @Component is AtScript syntax to annotate the HelloCmp class as an changular
// 2.0 component.
@Component({
  // The Selector prop tells changular on which elements to instantiate this
...
export function main() {
  ...
  // The boundary between the changular application and the rest of the page is
